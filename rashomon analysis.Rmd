...
```{r}
losses <- data.frame(
  t10000 = t100000$prediction - t10000$predictions,
  t1000 = t100000$prediction - t1000$predictions,
  t100 = t100000$prediction - t100$predictions,
  t10 = t100000$prediction - t10$predictions,
  t1 = t100000$prediction - t1$predictions
)
```
...
```{r}
ggplot(data = W, aes(x = highest_ed, y = placebo_cf$predictions)) +
  geom_jitter(alpha = 0.2) +
...
```{r}
ggplot(data = Y, aes(x = income, y = placebo_cf$predictions)) +
  geom_jitter(alpha = 0.2) +
  geom_smooth() +
  facet_zoom(ylim = c(-10000,10000)) +
